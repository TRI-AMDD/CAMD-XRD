"""
This script takes in the grid point density, materials project mp-id of a structure, and inter-atom distances to
generate the structure coordinates, rms distance from ideal structure, rvalues, and energies of all structures
